...
@section('title', (request('search') ? 'Hasil Pencarian: "' . request('search') . '"' : ($selectedCategory ? 'Kategori: ' . $selectedCategory->name : 'Berita Terbaru')) . ' | Desa ' . ($site_settings['village_name'] ?? ''))
