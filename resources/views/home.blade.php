...
>
    ...
    >
        ...
        <div class="w-full shrink-0 pt-3 pb-1 px-4 flex flex-col items-center text-center z-20 pointer-events-auto max-w-4xl mx-auto" @click.stop>
            ...
            <h3 id="home-gallery-lightbox-title" class="text-sm md:text-xl font-heading font-black tracking-tight text-white leading-snug line-clamp-2 mt-1 drop-shadow-xl" x-text="currentItem.title || ''"></h3>
