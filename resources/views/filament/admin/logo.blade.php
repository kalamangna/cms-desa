<div class="flex items-center gap-2.5" style="height: 2.5rem; display: flex; align-items: center;">
    <img src="{{ asset('img/sinjai.webp') }}" alt="Logo" style="height: 2rem !important; width: auto !important; max-height: 2rem !important; object-fit: contain;">
