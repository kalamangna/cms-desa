...
class SampleDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Seed Sample Statistic Data Values
        $statisticValues = [
            'Penduduk' => [
                'Jumlah Laki-laki' => [2021 => 1650, 2022 => 1680, 2023 => 1710, 2024 => 1750],
                'Jumlah Perempuan' => [2021 => 1600, 2022 => 1630, 2023 => 1660, 2024 => 1671],
            ],
            'Pendidikan' => [
                'SD' => [2021 => 520, 2022 => 530, 2023 => 540, 2024 => 550],
                'SMP' => [2021 => 410, 2022 => 420, 2023 => 430, 2024 => 440],
                'SMA' => [2021 => 310, 2022 => 320, 2023 => 335, 2024 => 350],
                'Sarjana' => [2021 => 85, 2022 => 95, 2023 => 110, 2024 => 125],
            ],
            'Pekerjaan' => [
                'Nelayan' => [2024 => 650],
                'Petani' => [2024 => 420],
            ...
            'Kemiskinan' => [
                'Keluarga Prasejahtera' => [2021 => 120, 2022 => 110, 2023 => 95, 2024 => 82],
            ],
            'Stunting' => [
                'Balita Stunting' => [2021 => 18, 2022 => 15, 2023 => 11, 2024 => 8],
            ],
            'UMKM' => [
                'Jumlah Unit UMKM' => [2021 => 25, 2022 => 32, 2023 => 40, 2024 => 52],
            ],
        ];

        foreach ($statisticValues as $catName => $indicators) {
            $category = \App\Models\StatisticCategory::where('name', $catName)->first();
            if ($category) {
                foreach ($indicators as $indName => $values) {
                    $indicator = \App\Models\StatisticIndicator::where('statistic_category_id', $category->id)
                        ->where('name', $indName)
                        ->first();
                    
                    if ($indicator) {
                        foreach ($values as $year => $value) {
                            \App\Models\StatisticData::updateOrCreate(
                                [
