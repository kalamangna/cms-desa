# BAB IX: PENGUJIAN (9_TESTING.md)

---

## 9.1 Hasil Pengujian Otomatis (Automated Testing)

Pengujian backend otomatis dieksekusi menggunakan **PHPUnit / Laravel Pest Framework** dengan lingkungan basis data khusus terisolasi (`RefreshDatabase`).
